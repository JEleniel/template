...
- You MUST follow these "Coding Rules" for all code that you write or modify. Existing code may have been written by other agents or users and you MUST NOT alter it simply for conformance.
